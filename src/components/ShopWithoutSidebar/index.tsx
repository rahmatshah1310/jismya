...
import { AllProductSkeleton, ProductGridSkeleton } from "../skeletons/product-skeleton";
...
const ShopWithoutSidebar = () => {
  ...
  // Helper function to build the pagination range dynamically
  const getPaginationRange = () => {
    const totalPageNumbers = 7; // max buttons visible (including ...)
    ...
    if (showLeftDots && !showRightDots) {
      let rightRange = Array.from({ length: 5 }, (_, i) => totalPages - 5 + 1 + i);
        ...
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-7.5">
            ...
            <div className="w-full">
                  ...
                  <div className="flex flex-wrap items-center gap-4">
                    <p>
                      ...
                      <span className="text-dark">
                        {Math.min(startIndex + visibleProducts.length, products.length)} of {products.length}
                      </span>{" "}
                      Products
                    </p>
                  </div>
              ...
              <div className={`${productStyle === "grid" ? "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7.5" : "flex flex-col gap-7.5"}`}>
                {isLoading ? (
                  // show 12 skeletons
                  <AllProductSkeleton count={12} />
                  ...
                  <div className="col-span-full text-center py-10">
                    <svg className="mx-auto mb-4" width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <circle cx="50" cy="50" r="50" fill="#F3F4F6" />
                      <path d="M35 40h30l-5 20H40l-5-20z" stroke="#9CA3AF" strokeWidth="2" fill="none" />
                    </svg>
                      ...
                      <li key={idx}>
                        {page === "..." ? (
                          ...
                          <button
                            ...
                            className={`px-3 py-1.5 rounded-[3px] ${currentPage === page ? "bg-blue text-white" : "hover:bg-blue hover:text-white"}`}
                          >
                            {page}
                          </button>
                        )}
