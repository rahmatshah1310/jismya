  ...
  return (
    <div className="flex items-center border-t border-gray-3 py-5 px-7.5">
      <div className="min-w-[400px]">
        <div className="flex items-center justify-between gap-5">
          <div className="w-full flex items-center gap-5.5">
            <Link href={`/product/${item._id}`}className="flex items-center justify-center rounded-[5px] bg-gray-2 max-w-[80px] w-full">
              <Image width={200} height={200} src={item.image || item.imageUrl || "/images/products/product-1-sm-1.png"} alt="product" />
            </Link>
      ...
      <div className="min-w-[180px]">
        <p className="text-dark">Rs. {item.discountedPrice ?? item.price}</p>
      </div>
      ...
      <div className="min-w-[200px]">
        <p className="text-dark">Rs. {(item.discountedPrice ?? item.price) * quantity}</p>
      </div>
