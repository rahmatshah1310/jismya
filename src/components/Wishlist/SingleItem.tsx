      ...
      <div className="min-w-[387px]">
        <div className="flex items-center justify-between gap-5">
          <div className="w-full flex items-center gap-5.5">
            <Link href={`/product/${item._id}`} className="flex items-center justify-center rounded-[5px] bg-gray-2 max-w-[80px] w-full h-17.5">
              <Image
            ...
            <div>
              <h3 className="text-dark ease-out duration-200 hover:text-blue">{item.productName}</h3>
            </div>
          </div>
        </div>
      </div>
