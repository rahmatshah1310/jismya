      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="mb-8 p-6 bg-gray-50 rounded-lg">
          ...
          <div className="flex items-center gap-2 mb-4">
            {[1,2,3,4,5].map((star) => (
              <button
                ...
                className={`w-10 h-10 transition-all duration-200 ${star <= (hoverRating || rating) ? "text-yellow-400 scale-110" : "text-gray-300 hover:text-yellow-400"}`}
              >
          ...
          <button
            ...
            className={`px-6 py-2 rounded-lg font-medium transition-colors ${!rating || createRating.isLoading ? "bg-gray-300 text-gray-500 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700 text-white"}`}
          >
