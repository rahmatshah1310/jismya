                ...
                <SwiperSlide key={banner._id || index}>
                  <div className="relative w-full h-full">
                    ...
                    <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-6">
                      <h2 className={`text-2xl md:text-5xl font-bold mb-3 ${isActive ? "animate-slide-up" : ""}`} style={{ animationDuration: "400ms" }}>
                        {banner.heading}
                      </h2>
                      ...
                      {banner.ctaText && banner.ctaLink && (
                        <Link href={banner.ctaLink}>
                          <Button size="lg" className={`${isActive ? "animate-scale-in" : ""}`} style={{ animationDuration: "300ms", animationDelay: "120ms" }}>
                            {banner.ctaText}
                          </Button>
                        </Link>
                      )}
